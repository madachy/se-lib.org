...
1. 0915 - 0935 (Madachy): [Overview of *se-lib* usage and architecture](<http://se-lib.org/tutorials/SD INCOSE Tutorial - Open Source System Modeling.pdf> "SysML modeling and diagrams") as demonstrated with system models generated by *se-lib*.
...
1. 1010 - 1130: Model library demonstrations and exercises
	...
	* (Madachy) [System dynamics simulation](<https://colab.research.google.com/drive/1oE5TBdF-hpJTQbQgSmPgmPoofBgOTR0B?usp=sharing>) Google Colab
