...
1. 0915 - 0935 (Madachy): Overview of *se-lib* usage and architecture as demonstrated with system models generated by *se-lib*.
...
1. 1010 - 1120: Model library demonstrations and exercises
	* (Longshore) [SysML modeling and diagrams](<http://se-lib.org/online/sysml.html> "SysML modeling and diagrams")
	* (Madachy) System dynamics continuous modeling and simulation
	* (Madachy) [Discrete event modeling and simulation](<http://se-lib.org/online/discrete_event_modeling_demo.html> "Discrete event modeling and simulation demonstrations")
	* (Longshore) Fault tree analysis, diagrams, and system reliability modeling
	* (Longshore) Project management modeling
	* (Madachy) Integration of models
...
1. 1120 - 1200 (Madachy/Longshore): Further examples, guided exercises, and extended case studies on above areas
...
1. 1330 - 1400 (Madachy / Longshore): Digital engineering and rapid change: automated model configuration management, re-execution, impact analysis and version control for round-trip digital engineering.
...
1. 1400 - 1430: Future capabilities and evolution plans
